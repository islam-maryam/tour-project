...
const BookTour = () => {
    ...
    return (
        <div className='w-[70%] border-x-2 border-neutral-800/5 mx-auto p-5'>
            <h1 className='text-5xl text-lime-900 font-extrabold text-center'>
            Discover Today, Think Tomorrow!
            </h1>
            ...
            <div className='mt-8'> 
                <div>
                    ...
                    <div className='mb-4'>
                        ...
                        <input 
                            type='text' 
                            placeholder='maryam11@gmail.com' 
                ...
                <button 
                    className=' justify-center mt-6 mb-20 bg-lime-900 hover:bg-lime-800 text-white text-xl px-20 py-3 rounded-full font-semibold'
                    onClick={makePayment}> 
                    Pay  
                </button> 
            </div>
